...
$GITHUB_USERNAME = "hugdora"
$REPOSITORY_NAME = "nest-app-project"
$SERVICE_PROVIDER_FILE_NAME = "AppServiceProvider"
$APPLICATION_CODE_FILE_NAME = "nest"
$RDS_ENDPOINT = "dev-nest-db.c0z2hfhc2nic.eu-west-2.rds.amazonaws.com"
...
$ECR_REPO_NAME = "nest-app"
$LOCAL_IMAGE_NAME = "nest-app"  
$IMAGE_TAG = "latest"
$AWS_REGION = "eu-west-2"
$AWS_ACCOUNT_ID = "127486921697"
