<section class="popular-categories section-padding">
    <div class="container wow animate__animated animate__fadeIn">
        ...
        <div class="carousel-10-columns-cover position-relative">
            <div class="carousel-slider-wrapper carousel-10-columns" id="carousel-10-columns" data-items-xxl="{{ (int)$shortcode->scroll_items > 0 ? (int)$shortcode->scroll_items : 10 }}" :title="'{!! BaseHelper::clean($shortcode->title) !!}'"slick_config="{{ json_encode([
